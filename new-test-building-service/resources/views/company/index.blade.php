...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
    <div class="row">
          <div class="col-md-10"><h4>Gestion des compagnies </h4></div>
        <div class="col-md-2"> <a href="{{route('companies.create')}}"><button class="btn btn-success pull-right"><i class="fa fa-plus"></i></button></a></div>
       </div>
